...
<!--Action boxes-->
  <div class="container-fluid">
    <div class="quick-actions_homepage">
        <center>
        <h1>Khách hàng</h1><br><br><br>
        <table style="text-align: center; width: 1000px;">
          <tr id="table-th">
            <th id="table-th">Mã khách hàng</th>
            <th id="table-th">Tên khách hàng</th>
            <th id="table-th">Số điện thoại</th>
            <th id="table-th">Địa chỉ</th>
            <th id="table-th">Tài khoản</th>
            <th id="table-th">Mật khẩu</th>
            <th id="table-th">Số tiền mua</th>
            <th id="table-th">Xóa</th>
            
        </tr>
        <c:forEach items="${list}" var="k">
                <tr>
                    <td id="table-td-short" style="height: 50px;">${k.maKH}</td>
                    
                    <td id="table-td-short">${k.hoTenKH}</td>
                    
                    <td id="table-td-short">${k.soDienThoaiKH}</td>
                    
                    
                    <td id="table-td-short">${k.diaChiKH} </td>
                    <td id="table-td-short">${k.taiKhoanKH} </td>
                    <td id="table-td-short">${k.matKhauKH} </td>
                    
                    <td id="table-td-short">${k.soTienMua}</td>
                    <td id="table-td-short">
                        <a href="deleteCustomerAD.htm?maKH=${k.maKH}" onclick="return  confirm('Xóa khách hàng sẽ xóa mọi đơn hàng. Xác nhận?')"><div style="width: 100%; height: 145px;  "><br><br><br>Xóa</div></a>
                    </td>
                </tr>
            </c:forEach>
        </table>
