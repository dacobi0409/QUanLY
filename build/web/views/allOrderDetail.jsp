...
<!--Action boxes-->
  <div class="container-fluid">
    <div class="quick-actions_homepage">
        <center>
        <h1>Đơn hàng chi tiết</h1><br><br><br>
        <table style="text-align: center; width: 1000px;">
          <tr id="table-th">
            <th id="table-th">Mã đơn hàng ct</th>
            <th id="table-th">Mã đơn</th>
            <th id="table-th">Sản phẩm</th>
            <th id="table-th">Ảnh</th>
            <th id="table-th">Giá khuyến mại</th>
            <th id="table-th">Số lượng</th>
            <th id="table-th">Xóa</th>
            
        </tr>
        <c:forEach items="${dhct}" var="dhct">
                <tr>
                    <td id="table-td-short" style="height: 50px;">${dhct.maDHCT}</td>
                    
                    <td id="table-td-short">${dhct.maDonHang.maDonHang}</td>
                    
                    <td id="table-td-long">${dhct.maSanPham.tenSanPham}</td>
                    
                    <td id="table-td-long"><img src="/products/resources/images/${dhct.maSanPham.urlAnh}" style="width: 60%; height: 145px;"/></td>
                    
                    <td id="table-td-short">${dhct.khuyenMai} vnđ</td>
                    
                    <td id="table-td-short">${dhct.soluong}</td>
                    <td id="table-td-short">
                        <a href="deleteOrderDT.htm?maDHCT=${dhct.maDHCT}" onclick="return  confirm('Xác nhận xóa?')"><div style="width: 100%; height: 145px;  "><br><br><br>Xóa</div></a>
                    </td>
                </tr>
            </c:forEach>
        </table>
