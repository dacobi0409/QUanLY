...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.htm" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
  </div>
<!--End-breadcrumbs-->
<!--Action boxes-->
    ...
    <div class="quick-actions_homepage">
        ...
        <c:forEach items="${list}" var="p">
                <tr>
                    ...
                    <td id="table-td-long">
                        <img src="/products/resources/images/${p.urlAnh}" width="150px" height="150px"/>
                    </td>
                    <td id="table-td-short">${p.tenSanPham}</td>
                    <td id="table-td-short">${p.giaGoc} vnd</td>
                    <td id="table-td-short">${p.khuyenMai} vnd</td>
                    <td id="table-td-long">${p.moTaNgan}</td>
                    <td id="table-td-short">
                        <a href="DetailProduct.htm?maSanPham=${p.maSanPham}" >Xem thêm</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
        <h5><a href="#">Thêm sản phẩm mới</a></h5>
      </center>
    </div>
  </div>
<!--End-Action boxes-->
