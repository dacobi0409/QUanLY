            ...
            <div class="  col-m-on">
                ...
                <div class="in-line">
                    <div class="para-all-in">
                        <center><h3>Sản phẩm dành cho nữ</h3></center>
                    </div>
                    <div class="lady-on">
                         <c:forEach items="${nu}" var="nu">
                            <div class="col-md-4 you-men" style="float: left; width: 250px; margin-left: 15px; margin-top: 20px;">
                                <a href="single.htm?maSanPham=${nu.maSanPham}"><img class="img-responsive pic-in" style="width: 250px; height: 300px;" src="/products/resources/images/${nu.urlAnh}" alt=" " ></a>
                                <p>${nu.tenSanPham}</p>
                                <span style="font-weight: 30px;"><fmt:formatNumber value="${nu.khuyenMai}">${nu.khuyenMai}</fmt:formatNumber>₫
                                                    <sup style="text-decoration: line-through;color: red;"><fmt:formatNumber value="${nu.giaGoc}">${nu.giaGoc}</fmt:formatNumber>₫</sup>  | 
                                                     <br><label class="cat-in"> </label>
                                                    <a href="addToCar.htm?maSanPham=${nu.maSanPham}">Thêm vào giỏ hàng</a>
                                                </span> 
                            </div>
                        </c:forEach>
                    <div class="clearfix"></div>
