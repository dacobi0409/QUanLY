...
<div id="sidebar"><a href="adminIndex.htm" class="visible-phone"><i class="icon icon-home" ></i>Menu</a>
  <ul>
    ...
    <li class="submenu"> <a href="detailUser.htm"><i class="icon icon-info-sign"></i> <span>Người dùng</span></a>
      <ul>
        <li><a href="allUser.htm">Tất cả người dùng mới</a></li>
...
<!--Action boxes-->
  <div class="container-fluid">
    <div class="quick-actions_homepage">
        <center>
        <h1>Quản lý đơn hàng</h1><br><br><br>
        <table style="text-align: center; width: 1000px;">
          <tr id="table-th">
            <th id="table-th">Mã đơn hàng</th>
            <th id="table-th">Ngày đặt hàng</th>
            <th id="table-th">Họ tên</th>
            <th id="table-th">Địa chỉ</th>
            <th id="table-th">Số điện thoại</th>
            <th id="table-th">Xóa</th>
        </tr>
        <c:forEach items="${list}" var="dh">
                <tr>
                    <td id="table-td-short"><a href="DetailOrder.htm?maDonHang=${dh.maDonHang}" ><div style="width: 100%; height: 145px; "><br><br><br>${dh.maDonHang}</div></a></td>
                    <td id="table-td-short"><a href="DetailOrder.htm?maDonHang=${dh.maDonHang}" ><div style="width: 100%; height: 145px; "><br><br><br>${dh.ngayDatHang}</div></a></td>
                    <td id="table-td-short"><a href="DetailOrder.htm?maDonHang=${dh.maDonHang}" ><div style="width: 100%; height: 145px; "><br><br><br>${dh.maKH.hoTenKH}</div></a></td>
                    <td id="table-td-short"><a href="DetailOrder.htm?maDonHang=${dh.maDonHang}" ><div style="width: 100%; height: 145px; "><br><br><br>${dh.maKH.diaChiKH}</div></a></td>
                    <td id="table-td-short"><a href="DetailOrder.htm?maDonHang=${dh.maDonHang}" ><div style="width: 100%; height: 145px; "><br><br><br>${dh.maKH.soDienThoaiKH}</div></a></td>
                    
                    <td id="table-td-short">
                        <a href="deleteOrder.htm?maDonHang=${dh.maDonHang}" onclick="return  confirm('Xác nhận xóa Đơn hàng?')"><div style="width: 100%; height: 145px;  "><br><br><br>Xóa</div></a>
                    </td>
