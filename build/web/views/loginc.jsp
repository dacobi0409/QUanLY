...
<body>
    ...
    <div class="content">			         
        <div class="container"> 			         
            ...
            <form action="btnDangNhapKH.htm" style="margin-left: 220px; margin-right: 220px; background-color: #f2f2f2;">
            ...
            <div class="  register-top-grid">
                    ...
                    <table style="width: 1000px; margin-left: 80px;">
                        <tr>
                            ...
                            <td><h2 style="color: red;">Đăng nhập khách hàng</h2><br> <p style="color: red;">&nbsp;&nbsp; ${tb}</p></td>
                            <td></td>
                        </tr><br>
                        ...
                        <tr>
                            <td>Tên tài khoản:</td>
                            <td>
                                <input type="text" placeholder="Ten tai khoan" class="form-control input-sm chat-input" style="float: left; width: 300px;" name="taiKhoanKH" required="Chưa nhập Tên tài khoản"/><br>
                            </td>
                        </tr>
                        <tr>
                            <td>Mật khẩu:</td>
                            <td>
                                <input type="password" placeholder="Mat khau" name="matKhauKH" required="Chưa nhập mật khẩu!" style="float: left; width: 300px;" /><br><br><br><br>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <input type="submit" class="btn btn-primary btn-md" value="Đăng nhập" /> &nbsp;
                             </td>
                        </tr>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <a href="signupC.htm"><div class="btn btn-default btn-sm btn-block" style="height: 30px; width: 95px;">Đăng ký</div></a>
                             </td>
                        </tr>
