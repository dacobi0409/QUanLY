...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <div class="quick-actions_homepage">
        <center>
        <h1>Quản lý người dùng(Users)</h1><br><br><br>
        
        <form action="lookupUser.htm">
            <input type="text" placeholder="Tìm kiếm" style="float: left;" name="ksUser" required=""/>
            <input type="submit" value="Tìm" id="toolBox"/>
        </form>
        <a href="allUser.htm"><div id="button-box">Tất cả</div></a>
        <a href="initInsertUser.htm"><div id="button-box">Thêm mới</div></a>
        ...
        <c:forEach items="${list}" var="u" varStatus="itr">
                <tr>
                    <div style="height: 100%; width: 100%;">
                        
                    <td id="table-td-short"><a href="detailUser.htm?id=${u.id}" ><div style="width: 100%; height: 145px; "><br><br><br>${u.id} </div></a></td>
                    <td id="table-td-short"><a href="detailUser.htm?id=${u.id}" ><div style="width: 100%; height: 145px; "><br><br><br>${u.taiKhoan} </div></a></td>
                    <td id="table-td-short"><a href="detailUser.htm?id=${u.id}" ><div style="width: 100%; height: 145px; "><br><br><br>${u.hoTen} </div></a></td>
                    <td id="table-td-short"><a href="detailUser.htm?id=${u.id}" ><div style="width: 100%; height: 145px; "><br><br><br>${u.soDienThoai} </div></a></td>
                    <td id="table-td-short"><a href="detailUser.htm?id=${u.id}" ><div style="width: 100%; height: 145px; "><br><br><br>${u.email}</div></a></td>
                    <td id="table-td-long"><a href="detailUser.htm?id=${u.id}" ><div style="width: 100%; height: 145px; "><img src="/products/resources/images/${u.urlAnhUser}" width=100px" height="40px"/></div></a></td>
                    <td id="table-td-short"><a href="preUpdateUser.htm?id=${u.id}"><div style="width: 100%; height: 145px;  "><br><br><br>Sửa</div></a>
                    <td id="table-td-short">
                        <a href="deleteUser.htm?id=${u.id}" onclick="return  confirm('Xác nhận xóa User?')"><div style="width: 100%; height: 145px;  "><br><br><br>Xóa</div></a>
                    </td>
                </tr>
            </c:forEach>
        </table>
