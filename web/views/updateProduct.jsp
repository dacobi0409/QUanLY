...
<!--Action boxes-->
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <h1>Cập nhật sản phẩm</h1><br><br><br>
      <center>
        <h3 style="color: red">${error}</h3>
        
        <form:form action="updateProduct.htm" modelAttribute="p" enctype="multipart/form-data">
            <table style="width: 1000px;">
                <tr>
                    <td><span id="td-insert">Mã sản phẩm</span></td>
                    <td>
                        <form:input type="text" path="maSanPham" readonly="true"/>
                ...
                <tr>
                    <td></td>
                    <td>
                        <input type="submit" value="Sửa"/>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
...
<div class="row-fluid">
  <div id="footer" class="span12"> 2020 &copy; <a href="redirect:index.jsp">Shop bán quần áo</a>.</div>
</div>
