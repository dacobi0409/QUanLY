...
<!--Action boxes-->
  <div class="container-fluid">
    ...
    <div class="quick-actions_homepage">
        <center>
        <h1>Quản lý sản phẩm</h1><br><br><br>
        
        <form action="lookUp.htm" accept-charset="UTF-8">
            <input type="text" placeholder="Tìm kiếm" style="float: left;" name="keySearch" required="" />
            <input type="submit" value="Tìm" id="toolBox"/>
        </form>
        <a href="listProduct.htm"><div id="button-box">Tất cả</div></a>
        <a href="initInsertProduct.htm"><div id="button-box">Thêm mới</div></a>
        <a href="menAdmin.htm"><div id="button-box">Quần áo Nam</div></a>
        <a href="womenAdmin.htm"><div id="button-box">Quần áo Nữ</div></a>
        ...
        <c:forEach items="${list}" var="p" >
                <tr>
                    <td id="table-td-short">${p.maSanPham}</td>
                    <td id="table-td-long"><a href="DetailProduct.htm?maSanPham=${p.maSanPham}" ><div style="width: 100%; height: 145px; "><img src="/products/resources/images/${p.urlAnh}" style="width: 60%; height: 145px;"/></div></a></td>
                    <td id="table-td-short"><a href="DetailProduct.htm?maSanPham=${p.maSanPham}" ><div style="width: 100%; height: 145px; "><br><br><br>${p.tenSanPham}</div></a></td>
                    <td id="table-td-short"><a href="DetailProduct.htm?maSanPham=${p.maSanPham}" ><div style="width: 100%; height: 145px; "><br><br><br>${p.giaGoc} vnd</div></a></td>
                    <td id="table-td-short"><a href="DetailProduct.htm?maSanPham=${p.maSanPham}" ><div style="width: 100%; height: 145px; "><br><br><br>${p.khuyenMai} vnd</div></a></td>
                    <td id="table-td-long"><a href="DetailProduct.htm?maSanPham=${p.maSanPham}" ><div style="width: 100%; height: 145px; "><br><br><br>${p.moTaNgan}</div></a></td>
                    <td id="table-td-short"><a href="preUpdateProduct.htm?maSanPham=${p.maSanPham}"><div style="width: 100%; height: 145px;  "><br><br><br>Sửa</div></a>
                    <td id="table-td-short">
                        <a href="deleteProduct.htm?maSanPham=${p.maSanPham}" onclick="return  confirm('Xác nhận xóa Sản Phẩm?')"><div style="width: 100%; height: 145px;  "><br><br><br>Xóa</div></a>
                    </td>
                </tr>
            </c:forEach>
        </table>
